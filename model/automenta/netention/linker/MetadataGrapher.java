...
public class MetadataGrapher {
    ...
    public static void run(Schema schema, Self s, MutableAdjacencyGraph<Node, ValueEdge<Node, Link>> target, boolean creators, boolean mode, boolean patterns, boolean properties) {
